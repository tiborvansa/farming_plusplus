...
minetest.register_alias("farming:potato_2", "farming_plus:potato_2")
minetest.register_alias("docfarming:potato3", "farming_plus:potato_3")
minetest.register_alias("farming:potato_3", "farming_plus:potato_3")
minetest.register_alias("docfarming:potato4", "farming_plus:potato_4")
minetest.register_alias("farming:potato_4", "farming_plus:potato_4")
