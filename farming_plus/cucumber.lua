...
minetest.register_alias("docfarming:cucumber3", "farming_plus:cucumber_3")
minetest.register_alias("farming:cucumber_3", "farming_plus:cucumber_3")
minetest.register_alias("docfarming:cucumber4", "farming_plus:cucumber_4")
minetest.register_alias("farming:cucumber_4", "farming_plus:cucumber_4")
